...
{
     cout << endl
          << "Test Exercise 1A - Vectors and Lists (Extended)" << endl;

     // Test Integer List
     cout << endl
          << "Test Integer List" << endl;
...
{
     cout << endl
          << "Test Exercise 1B - Sets (Extended)" << endl;

     // Test Integer SetLst
     cout << endl
          << "Test Integer SetLst" << endl;
...
// Test functions for Exercise 2A - Heap
void testExercise2A(uint &testnum, uint &testerr)
{
     cout << endl
          << "Test Exercise 2A - Heap (Extended)" << endl;

     mytestHeapInt(testnum, testerr);
     mytestHeapString(testnum, testerr);
}

// Test functions for Exercise 2B - Priority Queue
void testExercise2B(uint &testnum, uint &testerr)
{
     cout << endl
          << "Test Exercise 2B - Priority Queue (Extended)" << endl;
...
{
     cout << endl
          << "~*~#~*~ My Extended LASD Test Suite ~*~#~*~ " << endl;

     uint testnum = 0, testerr = 0;

     testExercise1A(testnum, testerr);
     testExercise1B(testnum, testerr);
     testExercise2A(testnum, testerr);
     testExercise2B(testnum, testerr);

     cout << endl
          << "Extended Tests (Errors/Tests: " << testerr << "/" << testnum << ")" << endl;
}
